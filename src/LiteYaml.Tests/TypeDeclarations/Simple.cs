...
using LiteYaml.Annotations;

namespace LiteYaml.Tests.TypeDeclarations
{
    [YamlObject]
    ...
    public partial class WithDefaultValue(int valueSet, int value = 12)
    {
        public readonly int Value = value;
        public readonly int ValueSet = valueSet;
    }
    ...
    [YamlObject]
    public partial class AbstractImpl1(int a, string b) : AbstractUnion
    {
        public override int A { get; protected set; } = a;
        public string B { get; private set; } = b;
    }

    [YamlObject]
    public partial class AbstractImpl2(int a, string c) : AbstractUnion
    {
        public override int A { get; protected set; } = a;
    ...
    [YamlObject]
    public partial class WithCustomConstructor(int foo, string bar)
    {
    ...
    [YamlObject]
    [method: YamlConstructor]
    public partial class WithCustomConstructorAndOtherProps(int foo, string bar)
    {
        public int Foo { get; } = foo;
        public string Bar { get; } = bar;
...
namespace LiteYaml.Tests.TypeDeclarations.More
{
    [YamlObject]
