...
{
    const string Category = "YamlLibrary.SourceGenerator";
    ...
    public static readonly DiagnosticDescriptor MustBePartial = new(
        id: "VYAML002",
        title: "YamlLibrary serializable type declaration must be partial",
        messageFormat: "The YamlLibrary serializable type declaration '{0}' must be partial",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor NestedNotAllow = new(
        id: "VYAML003",
        title: "YamlLibrary serializable type must not be nested type",
        messageFormat: "The YamlLibrary serializable object '{0}' must be not nested type",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor YamlMemberPropertyMustHaveSetter = new(
        ...
        messageFormat: "The YamlLibrary serializable object '{0}' property '{1}' must have setter",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor YamlMemberFieldCannotBeReadonly = new(
        ...
        messageFormat: "The YamlLibrary serializable object '{0}' field '{1}' cannot be readonly",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor ConstructorHasNoMatchedParameter = new(
        id: "VYAML0015",
        title: "YamlLibrary's constructor has no matched parameter",
        messageFormat: "The YamlLibrary object '{0}' constructor's parameter '{1}' must match a serialized member name(case-insensitive)",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
}
