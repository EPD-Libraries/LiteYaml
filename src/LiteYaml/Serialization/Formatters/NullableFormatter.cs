...
namespace LiteYaml.Serialization
{
    ...
    public sealed class StaticNullableFormatter<T>(IYamlFormatter<T> underlyingFormatter) : IYamlFormatter<T?> where T : struct
    {
        readonly IYamlFormatter<T> underlyingFormatter = underlyingFormatter;
