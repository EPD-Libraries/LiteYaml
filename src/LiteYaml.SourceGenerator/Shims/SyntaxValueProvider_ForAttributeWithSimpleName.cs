...
internal static partial class SyntaxValueProviderExtensions
{
    ...
    /// </summary>
    private sealed class SyntaxTreeInfo(SyntaxTree tree, bool containsGlobalAliases, bool containsAttributeList) : IEquatable<SyntaxTreeInfo>
    {
        public readonly SyntaxTree Tree = tree;
        public readonly bool ContainsGlobalAliases = containsGlobalAliases;
        public readonly bool ContainsAttributeList = containsAttributeList;
